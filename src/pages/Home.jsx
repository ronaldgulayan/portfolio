...
function Home() {
  return (
    <div
      id='home'
      className='con w-full min-h-screen text-slate-200 px-pad-md md:px-pad md:grid md:grid-cols-2 flex flex-col gap-x-10 pt-[6.5rem] gap-y-10 md:pt-0 pb-5 md:pb-0'
    >
